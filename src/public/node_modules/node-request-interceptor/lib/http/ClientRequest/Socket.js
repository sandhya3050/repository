...
var Socket = /** @class */ (function (_super) {
    ...
    function Socket(options, socketOptions) {
    ...
    Socket.prototype.resolvePort = function (port) {
        if (port == null) {
            return 0;
        }
    ...
    Socket.prototype.applyDelay = function (duration) {
    ...
    Socket.prototype.getPeerCertificate = function () {
